    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("1 hour", callback_data="setdel_3600"),
             InlineKeyboardButton("3 hours", callback_data="setdel_10800"),
             InlineKeyboardButton("6 hours", callback_data="setdel_21600")],
            [InlineKeyboardButton("8 hours", callback_data="setdel_28800"),
             InlineKeyboardButton("12 hours", callback_data="setdel_43200"),
